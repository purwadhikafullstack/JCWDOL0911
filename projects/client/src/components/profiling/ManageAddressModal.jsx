    ...
    <div className="fixed inset-0 bg-black bg-opacity-25 backdrop-blur-sm flex justify-center items-center">
      <div className="bg-white py-3 lg:px-14 px-2 rounded-xl gap-2 flex flex-col shadow-lg w-96 lg:w-[32rem] max-h-screen">
        <div className="relative flex justify-between items-end">
          <h5 class="text-xl lg:text-3xl pb-3 font-medium text-gray-900 dark:text-white">My Address</h5>
          <button onClick={() => setOpen(false)} className='absolute top-0 right-0'>
            <svg
              className="h-6 w-6"
