...
function MyAddressCard({ address }) {
  ...
  return (
<div class="block w-full bg-white border border-emerald-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 p-4">
    ...
    <div class="flex gap-4">
        <div>
            ...
            <p class="font-normal text-gray-700 dark:text-gray-400 text-sm"> { address.district }, {address.postal_code }</p>
        </div>
    </div>
              <div className="mt-auto">
              {!address.isprimary ? <div className='flex gap-3 '>
