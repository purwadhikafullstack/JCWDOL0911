...
function UploadModal() {
  ...
  <div className='bg-white p-4 rounded-lg shadow-lg'>
    <h1 className='text-2xl font-bold mb-4 text-center'>Upload Your Picture</h1>
  ...
  onChange={(e) => {
    ...
    <p className='text-sm text-gray-500'>*Max size 1MB. Allowed extensions: .png, .jpg, .jpeg, .gif</p>
