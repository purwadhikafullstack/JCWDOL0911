...
function MyQuestionCard({ question }) {
  ...
  return (
      <div className='flex border-b-2 py-2 gap-2 border-emerald-500 w-full items-center '>
        ...
        {question.is_answer?
              <p className=' bg-green-300 rounded-md text-white px-3 py-1 h-10'>answer</p> :
              <p className=' bg-red-400 rounded-md text-white px-3 py-1 h-10'>answer</p>}
              {dateNow > expired || question.is_answer ? <div className='w-6 h-6'></div> :
