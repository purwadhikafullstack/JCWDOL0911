...
import { createCategory, getAllCategory } from '../../features/cartegory/categorySlice';
...
function Categories() {
  ...
  <div className="flex items-start gap-3 justify-center">
    ...
    />
    <Button colorScheme="teal" size="md" onClick={() => handleCreateCategory()}>
      Create
    </Button>
  </div>
</div>                <div className="flex flex-col flex-grow  ">
              <div className="flex items-center ">
                <select value={sortOption} onChange={sortHandler} className='border-2 border-r-0 rounded-l-md h-8 bg-emerald-300 border-emerald-300 text-black px-2 lg:w-36'>
